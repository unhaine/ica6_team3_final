...
- [x] 1.3 이미지 업로드 컴포넌트 구현
  - [x] 파일 선택 버튼
  - [x] 드래그 앤 드롭 지원
  - [x] 이미지 미리보기
- [x] 1.4 업로드된 이미지 상태 관리
...
- [x] 2.1 API Route 생성 (`/api/vision/analyze`)
- [x] 2.2 이미지 Base64 인코딩
- [x] 2.3 Vision API Object Localization 호출
- [x] 2.4 응답 파싱 및 정규화
  - [x] Bounding Box 좌표 (normalized vertices → 0~1)
  - [x] 라벨 및 신뢰도
...
- [x] 3.1 Canvas 라이브러리 선택 및 설치 (Konva.js)
- [x] 3.2 BoundingBoxCanvas 컴포넌트 구현
  - [x] 이미지 렌더링
  - [x] 박스 오버레이 렌더링
- [x] 3.3 박스 드래그 기능 구현
- [x] 3.4 라벨 + 신뢰도 표시
- [x] 3.5 박스 좌표 업데이트 상태 관리
...
- [x] Vision API 결과가 이미지 위에 박스로 표시
- [x] 박스를 드래그하여 위치 변경 가능
- [x] 라벨과 신뢰도가 박스 위에 표시
