export const STYLES = {
    container: "fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[860px] z-50 bg-white border-t border-gray-100 flex items-center justify-around px-2 min-h-[70px] pb-safe transition-all duration-300",
